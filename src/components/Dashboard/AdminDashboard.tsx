    ...
    <>
        ...
        <div className="rounded-lg  m-5">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="text-center sm:text-left">
              <p className="text-2xl font-bold text-gray-900 ">Manager List</p>
            </div>
            ...
            <tbody className="divide-y divide-gray-100 border-t border-gray-100">
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4">
                  <span className="inline-flex items-center gap-1 rounded-full bg-orange-50 px-2 py-1 text-xs font-semibold text-black-600">
      ...
      <div>
        <div className="rounded-lg  m-5">
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="text-center sm:text-left">
              <p className="text-2xl font-bold text-gray-900 ">Users List</p>
            </div>
